package net.kkuras.tutorialmod.compat;
...
import net.kkuras.tutorialmod.recipe.GrowthChamberRecipe;
...
public class GrowthChamberRecipeCategory implements IRecipeCategory<GrowthChamberRecipe> {
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, GrowthChamberRecipe recipe, IFocusGroup iFocusGroup) {
