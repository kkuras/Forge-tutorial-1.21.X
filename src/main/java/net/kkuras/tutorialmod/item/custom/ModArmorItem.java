package net.kkuras.tutorialmod.item.custom;

import com.google.common.collect.ImmutableMap;
import net.kkuras.tutorialmod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    ...
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.ALEXANDRITE_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.JUMP, 300, 2, false, false),
    ...
    public void onInventoryTick(ItemStack stack, Level level, Player player, int slotIndex, int selectedIndex) {
        if(!level.isClientSide() && hasFullSuitOfArmorOn(player) && level.getGameTime() % 100 == 0) {
