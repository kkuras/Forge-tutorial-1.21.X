...
import net.kkuras.tutorialmod.worldgen.MobBiomeModifiers;
import net.kkuras.tutorialmod.worldgen.ModConfiguredFeatures;
import net.kkuras.tutorialmod.worldgen.ModPlacedFeatures;
...
public class ModDatapackEntries extends DatapackBuiltinEntriesProvider {
    ...
    public static final RegistrySetBuilder BUILDER = new RegistrySetBuilder()
            ...
            .add(ForgeRegistries.Keys.BIOME_MODIFIERS, MobBiomeModifiers::bootstrap);
